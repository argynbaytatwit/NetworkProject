...
# Form implementation generated from reading ui file 'NetworkProgramming.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Make the "To (user)" label big and bold so it stands out
        font = self.user_label.font()
        font.setPointSize(16)  # adjust size if you want even larger [web:121][web:124]
        font.setBold(True)
        ...
        left_layout.addWidget(self.user_message, 1)
        ...
        # Single inbox view (cleaner, fills right side)
        self.graphicsView = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView.setObjectName("graphicsView")
        right_layout.addWidget(self.graphicsView, 1)

        # Add left and right layouts to main layout with equal stretch
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelintro.setText(_translate("MainWindow", "Send Message"))
        self.label_2.setText(_translate("MainWindow", "Inbox"))
        # New label text here
        self.user_label.setText(_translate("MainWindow", "Send To:  enter username"))
        self.label_4.setText(_translate("MainWindow", "Message"))
        self.pushButton_2.setText(_translate("MainWindow", "Refresh"))
        self.menuEmail_Client.setTitle(_translate("MainWindow", "Messenger"))
